...
static void get_device_service_name(char *service_name, size_t max){
    ...
    snprintf(
        service_name, max, "%s%02X%02X%02X",
...
void app_main(void){
    ...
    ESP_LOGE(TAG, "**************** Iniciando STA ****************");
    esp_netif_create_default_wifi_sta();
    ESP_LOGE(TAG, "**************** Iniciando AP ****************");
    esp_netif_create_default_wifi_ap();
    wifi_init_config_t cfg = WIFI_INIT_CONFIG_DEFAULT();
    ESP_ERROR_CHECK(esp_wifi_init(&cfg));

    /* Configuration for the provisioning manager */
    ESP_LOGE(TAG, "**************** Configurando PROV ****************");
    ...
    ESP_LOGE(TAG, "**************** Configurando WIFI PROV ****************");
    ...
    ESP_LOGE(TAG, "**************** Revisando si esta provisionado ****************");
    ESP_ERROR_CHECK(wifi_prov_mgr_is_provisioned(&provisioned));
#endif
    ESP_LOGE(TAG, "Provisioned: %d", provisioned);
